...
class PilhaDinamica {
    ...
    public static void lerComando(String comando, PilhaFlexivel pilha) {
        ...
        switch (comand[0]) {
            /*
             * case "II": character2.readCharacter(comand[1]);
             * list.inserirInicio(character2); break;
             */
            case "I":
                character2.readCharacter(comand[1]);
                pilha.inserirFinal(character2);
                break;
            /*
             ...
             * character2.getName()); break;
             */
            case "R":
                character2 = pilha.removerFinal();
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < enterNumber; i++) {
            ...
            pilha.inserirFinal(character[i]);
        }
